...
var require_window = __commonJS({
  "node_modules/vue-video-player/node_modules/global/window.js"(exports, module) {
    var win;
    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "min-document" has been externalized for browser compatibility. Cannot access "min-document.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_document = __commonJS({
  "node_modules/vue-video-player/node_modules/global/document.js"(exports, module) {
...
var require_tsml = __commonJS({
  "node_modules/tsml/tsml.js"(exports, module) {
    function clean(s) {
      return s.replace(/\n\r?\s*/g, "");
    }
...
var require_window2 = __commonJS({
  "node_modules/xhr/node_modules/global/window.js"(exports, module) {
    var win;
    if (typeof window !== "undefined") {
      win = window;
    } else if (typeof global !== "undefined") {
...
var require_vtt = __commonJS({
  "node_modules/vue-video-player/node_modules/videojs-vtt.js/lib/vtt.js"(exports, module) {
...
var require_vttcue = __commonJS({
  "node_modules/vue-video-player/node_modules/videojs-vtt.js/lib/vttcue.js"(exports, module) {
...
var require_vttregion = __commonJS({
  "node_modules/vue-video-player/node_modules/videojs-vtt.js/lib/vttregion.js"(exports, module) {
    var scrollSetting = {
      "": true,
      "up": true
    };
...
var require_browser_index = __commonJS({
  "node_modules/vue-video-player/node_modules/videojs-vtt.js/lib/browser-index.js"(exports, module) {
...
var require_video_cjs = __commonJS({
  "node_modules/vue-video-player/node_modules/video.js/dist/video.cjs.js"(exports, module) {
    ...
    var elData = {};
    var elIdAttr = "vdata" + (/* @__PURE__ */ new Date()).getTime();
    function getData(el) {
      var id = el[elIdAttr];
      if (!id) {
      ...
      Component2.prototype.emitTapEvents = function emitTapEvents() {
        ...
        this.on("touchstart", function(event2) {
          if (event2.touches.length === 1) {
            ...
            touchStart = (/* @__PURE__ */ new Date()).getTime();
            couldBeTap = true;
          }
        });
        ...
        this.on("touchend", function(event2) {
          firstTouch = null;
          if (couldBeTap === true) {
            var touchTime = (/* @__PURE__ */ new Date()).getTime() - touchStart;
    ...
    videojs.hookOnce = function(type, fn) {
      videojs.hooks(type, [].concat(fn).map(function(original) {
        var wrapper = function wrapper2() {
          videojs.removeHook(type, wrapper2);
...
var require_vue_video_player = __commonJS({
  "node_modules/vue-video-player/dist/vue-video-player.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t(require_video_cjs()) : "function" == typeof define && define.amd ? define(["videojs"], t) : "object" == typeof exports ? exports.VueVideoPlayer = t(require_video_cjs()) : e.VueVideoPlayer = t(e.videojs);
    }(exports, function(e) {
      return function(e2) {
        function t(i) {
          if (n[i]) return n[i].exports;
          var r = n[i] = { i, l: false, exports: {} };
          return e2[i].call(r.exports, r, r.exports, t), r.l = true, r.exports;
        }
        var n = {};
        return t.m = e2, t.c = n, t.i = function(e3) {
          return e3;
        }, t.d = function(e3, n2, i) {
          t.o(e3, n2) || Object.defineProperty(e3, n2, { configurable: false, enumerable: true, get: i });
        }, t.n = function(e3) {
        ...
        var r = n(0), o = function(e3) {
          return e3 && e3.__esModule ? e3 : { default: e3 };
        }(r), s = window.videojs || o.default;
        "function" != typeof Object.assign && Object.defineProperty(Object, "assign", { value: function(e3, t2) {
          if (null == e3) throw new TypeError("Cannot convert undefined or null to object");
          for (var n2 = Object(e3), i2 = 1; i2 < arguments.length; i2++) {
            var r2 = arguments[i2];
            if (null != r2) for (var o2 in r2) Object.prototype.hasOwnProperty.call(r2, o2) && (n2[o2] = r2[o2]);
          }
          return n2;
        }, writable: true, configurable: true });
        var a = ["loadeddata", "canplay", "canplaythrough", "play", "pause", "waiting", "playing", "ended", "error"];
        t.default = { name: "video-player", props: { start: { type: Number, default: 0 }, crossOrigin: { type: String, default: "" }, playsinline: { type: Boolean, default: false }, customEventName: { type: String, default: "statechanged" }, options: { type: Object, required: true }, events: { type: Array, default: function() {
          return [];
        } }, globalOptions: { type: Object, default: function() {
          return { controls: true, controlBar: { remainingTimeDisplay: false, playToggle: {}, progressControl: {}, fullscreenToggle: {}, volumeMenuButton: { inline: false, vertical: true } }, techOrder: ["html5"], plugins: {} };
        } }, globalEvents: { type: Array, default: function() {
          return [];
        } } }, data: function() {
          return { player: null, reseted: true };
        }, mounted: function() {
          this.player || this.initialize();
        }, beforeDestroy: function() {
          this.player && this.dispose();
        }, methods: { initialize: function() {
          var e3 = this, t2 = Object.assign({}, this.globalOptions, this.options);
          this.playsinline && (this.$refs.video.setAttribute("playsinline", this.playsinline), this.$refs.video.setAttribute("webkit-playsinline", this.playsinline), this.$refs.video.setAttribute("x5-playsinline", this.playsinline), this.$refs.video.setAttribute("x5-video-player-type", "h5"), this.$refs.video.setAttribute("x5-video-player-fullscreen", false)), "" !== this.crossOrigin && (this.$refs.video.crossOrigin = this.crossOrigin, this.$refs.video.setAttribute("crossOrigin", this.crossOrigin));
          var n2 = function(t3, n3) {
            t3 && e3.$emit(t3, e3.player), n3 && e3.$emit(e3.customEventName, i({}, t3, n3));
          };
          t2.plugins && delete t2.plugins.__ob__;
          var r2 = this;
          this.player = s(this.$refs.video, t2, function() {
            for (var e4 = this, t3 = a.concat(r2.events).concat(r2.globalEvents), i2 = {}, o2 = 0; o2 < t3.length; o2++) "string" == typeof t3[o2] && void 0 === i2[t3[o2]] && function(t4) {
              i2[t4] = null, e4.on(t4, function() {
                n2(t4, true);
              });
            }(t3[o2]);
            this.on("timeupdate", function() {
              n2("timeupdate", this.currentTime());
            }), r2.$emit("ready", this);
          });
        }, dispose: function(e3) {
          var t2 = this;
          this.player && this.player.dispose && ("Flash" !== this.player.techName_ && this.player.pause && this.player.pause(), this.player.dispose(), this.player = null, this.$nextTick(function() {
            t2.reseted = false, t2.$nextTick(function() {
              t2.reseted = true, t2.$nextTick(function() {
                e3 && e3();
              });
            });
          }));
        } }, watch: { options: { deep: true, handler: function(e3, t2) {
          var n2 = this;
          this.dispose(function() {
            e3 && e3.sources && e3.sources.length && n2.initialize();
          });
        } } } };
      }, function(e2, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: true });
        var i = n(1), r = n.n(i);
        for (var o in i) ["default", "default"].indexOf(o) < 0 && function(e3) {
          n.d(t, e3, function() {
            return i[e3];
          });
        }(o);
        var s = n(5), a = n(4), l = a(r.a, s.a, false, null, null, null);
        t.default = l.exports;
      }, function(e2, t, n) {
        "use strict";
        function i(e3) {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.install = t.videoPlayer = t.videojs = void 0;
        var r = n(0), o = i(r), s = n(2), a = i(s), l = window.videojs || o.default, u = function(e3, t2) {
          t2 && (t2.options && (a.default.props.globalOptions.default = function() {
            return t2.options;
          }), t2.events && (a.default.props.globalEvents.default = function() {
            return t2.events;
          })), e3.component(a.default.name, a.default);
        }, d = { videojs: l, videoPlayer: a.default, install: u };
        t.default = d, t.videojs = l, t.videoPlayer = a.default, t.install = u;
      }, function(e2, t) {
        e2.exports = function(e3, t2, n, i, r, o) {
          var s, a = e3 = e3 || {}, l = typeof e3.default;
          "object" !== l && "function" !== l || (s = e3, a = e3.default);
          var u = "function" == typeof a ? a.options : a;
          t2 && (u.render = t2.render, u.staticRenderFns = t2.staticRenderFns, u._compiled = true), n && (u.functional = true), r && (u._scopeId = r);
          var d;
          if (o ? (d = function(e4) {
            e4 = e4 || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, e4 || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e4 = __VUE_SSR_CONTEXT__), i && i.call(this, e4), e4 && e4._registeredComponents && e4._registeredComponents.add(o);
          }, u._ssrRegister = d) : i && (d = i), d) {
            var c = u.functional, f = c ? u.render : u.beforeCreate;
            c ? (u._injectStyles = d, u.render = function(e4, t3) {
              return d.call(t3), f(e4, t3);
        ...
        var i = function() {
          ...
          return e3.reseted ? n2("div", { staticClass: "video-player" }, [n2("video", { ref: "video", staticClass: "video-js" })]) : e3._e();
...
export default require_vue_video_player();
